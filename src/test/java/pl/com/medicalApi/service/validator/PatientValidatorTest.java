...
import pl.com.medicalApi.utils.PatientTestUtils;
...
class PatientValidatorTest {
    ...
    void createValidate_WhenPatientIsValid_ShouldExceptionWillBeNotThrown() {
        ...
        //given
        var postPatientDto = PatientTestUtils.createValidPostPatientDto();
    ...
    void createValidate_WhenPatientIsExists_ShouldExceptionWillBeThrown() {
        ...
        //then
        Assertions.assertEquals("Patient with personal identity number: " + postPatientDto.getPersonalIdentityNumber() + " exists", exception.getMessage());
    }
    ...
    void deleteValidate_WhenPatientIsNotExists_ShouldExceptionWillBeThrown() {
        ...
        //given
        var patient = PatientTestUtils.createNotExistsPatient();
